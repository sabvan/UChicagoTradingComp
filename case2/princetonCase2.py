...
data = pd.read_csv("testdata1.csv", index_col = 0)

TRAIN, TEST = train_test_split(data, test_size = 0.2, shuffle = False)

# TO GRADERS: We could not test the Allocator below on a python file, 
# but it worked on ipynb. If the code does not run, use the commented out
# Allocator
